...
import Testimon1 from "../../img/Testimonial/testimo1.png";
import Testimo from "../../img/Testimonial/testimo.png";
import Testimon4 from "../../img/Testimonial/testim4.jpg";
            ...
            >
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      I patronized Samuel and when He delivered, I honestly
                  ...
                  <div className="client-info">
                    <img src={Testimo} alt="no internet connection"></img>
                    <h5>Georgina Greg</h5>
                    <p>Team Lead Oracle</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={Testimon1} alt="no internet connection"></img>
                    <h5>Leonard George</h5>
                    <p>Software Engineer Toptal</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-12">
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={Testimon4} alt="no internet connection"></img>
                    <h5>Stella Nyagah</h5>
